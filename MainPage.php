...
<body>
    <header>
        <div class="logo">
            <img src="_logo.png" alt="Logo do site">
        ...
        <div class="background">
            <div class="page-inner-content">
                ...
                <div class="Products-row">
                    <?php
                    //gerar de 1 a 6 blocos de produtos.
                    for ($i = 1; $i <= 6; $i++) {
                        echo '<a href="pagina_produto_' . $i . '.php" class="Product-link">';
                        echo '<div class="Products">';
                        echo '<p class="SellersName">Vendedor ' . $i . '</p>'; 
                        echo '<img src="Produto_' . $i . '" alt="" />'; 
                        echo '<p class="Price">EURO</p> <span>€</span>'; 
                        echo '<p class="Estado">Condição do Produto</p>'; 
                        echo '</div>';
                        echo '</a>';
                    }
                    ?>
